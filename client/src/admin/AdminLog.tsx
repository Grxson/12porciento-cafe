...
const SELECT_CLASS =
  'bg-white dark:bg-coffee-800 border border-coffee-200 dark:border-coffee-700 text-coffee-900 dark:text-cream text-sm px-3 py-2 focus:outline-none focus:border-gold-500/50';
                ...
                <tbody>
                  {logs.map((log) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <span
                          className={`text-xs px-2 py-0.5 font-medium ${ACTION_COLORS[log.action] ?? 'text-coffee-600 dark:text-coffee-400 bg-coffee-100 dark:bg-coffee-800'}`}
                        >
                          {log.action}
                        </span>
                      </td>
                      <td className="px-4 py-3 text-coffee-900 dark:text-cream text-xs font-medium">
                        {log.entity}
                      </td>
