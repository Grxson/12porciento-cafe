...
export default function Footer() {
  return (
    <footer className="pwa-footer mt-16 border-t border-coffee-200/60 bg-gradient-to-b from-coffee-100 to-coffee-50 dark:border-coffee-800/60 dark:from-coffee-900 dark:to-coffee-950 md:mt-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-2">
            <Link to="/" className="flex flex-col leading-none mb-4">
              <span className="font-serif text-3xl font-bold text-coffee-900 dark:text-cream">
                12%
              </span>
              <span className="text-xs tracking-widest text-gold-600 dark:text-gold-500 uppercase">
                doce por ciento
              </span>
            </Link>
            <p className="text-coffee-700 dark:text-coffee-300 text-sm leading-relaxed max-w-xs">
              Solo el 12% del café producido en el mundo es de especialidad. Ese es nuestro
              universo. Origen único, trazabilidad total, directo del productor a tu taza.
            </p>
            ...
            <div className="flex gap-4 mt-6">
              <div className="w-11 h-11 border border-coffee-200 dark:border-coffee-700 hover:border-gold-500/40 flex items-center justify-center transition-colors">
                <a
                  href="https://www.instagram.com/12porciento.cafe/"
                  target="_blank"
              ...
              <div className="w-11 h-11 border border-coffee-200 dark:border-coffee-700 hover:border-gold-500/40 flex items-center justify-center transition-colors">
                <a
                  href="mailto:hola@12porciento.com"
          ...
          <div>
            <h4 className="text-xs tracking-widest uppercase text-gold-600 dark:text-gold-500 mb-5">
              Tienda
            </h4>
            <ul className="space-y-3">
              {[
                ...
                <li key={to}>
                  <Link
                    to={to}
                    className="text-coffee-700 dark:text-coffee-300 hover:text-coffee-950 dark:hover:text-cream text-sm transition-colors inline-flex items-center min-h-[44px]"
                  >
                    {label}
                  </Link>
                </li>
