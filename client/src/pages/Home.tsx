...
export default function Home() {
  ...
  return (
    <div>
      <PageMeta
        title="Inicio"
        description="Café de especialidad mexicano. Descubre notas florales y cítricas de Veracruz y Chiapas."
      />
      {/* ── HERO ── */}
      <section
        ref={heroRef}
        className="relative min-h-screen flex items-center justify-center overflow-hidden bg-coffee-950"
      >
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          >
            <Link
              to="/tienda"
              className="btn-primary w-full sm:w-auto min-h-[48px] flex items-center justify-center"
            >
              Explorar Tienda
            </Link>
            <Link
              to="/suscripciones"
              className="btn-outline-dark w-full sm:w-auto min-h-[48px] flex items-center justify-center"
            >
              Ver Suscripciones
            </Link>
          </motion.div>
        ...
        >
          <span className="text-coffee-500 dark:text-coffee-400 text-xs tracking-widest uppercase">
            Descubre
          </span>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-coffee-200/40 dark:divide-coffee-800/40">
            {[
              ...
              <div key={label} className="flex items-center gap-3 px-4 sm:px-6 py-4 md:py-5">
                ...
                <div>
                  <p className="text-coffee-900 dark:text-cream text-xs font-semibold tracking-wide">
                    {label}
                  </p>
                  <p className="text-coffee-600 dark:text-coffee-400 text-xs tracking-wide mt-0.5">
                    {sub}
                  </p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal direction="left">
              <div className="relative">
                ...
                <div className="absolute -bottom-6 -right-6 bg-gold-500 p-8 hidden sm:block">
                  ...
                  <p className="text-coffee-950/70 text-xs tracking-widest uppercase mt-1">
                    Por ciento
                  </p>
                </div>
              </div>
            ...
            <ScrollReveal delay={0.2}>
              ...
              <h2 className="section-title mb-6">
                El café más excepcional
                <br />
                <em className="text-gold-500">del mundo</em>
              </h2>
              <p className="text-coffee-800 dark:text-coffee-300 leading-relaxed mb-6">
                De toda la producción cafetalera global, únicamente el 12% alcanza los estándares de
                la Specialty Coffee Association con puntajes superiores a 80 puntos. Nosotros
              ...
              <p className="text-coffee-700 dark:text-coffee-300 leading-relaxed mb-8">
                ...
                protocolos SCA estrictos y tostado en pequeños lotes para garantizar que llegue a tu
                taza en su punto máximo de expresión sensorial.
              </p>
              <Link
                to="/nosotros"
                className="inline-flex items-center gap-2 text-gold-500 hover:text-gold-400 transition-colors text-sm tracking-widest uppercase"
              >
            ...
            {[
              {
                ...
                icon: Sprout,
                title: 'Origen',
                desc: 'Fincas seleccionadas en alturas de 1,200–1,800 msnm en Veracruz y Chiapas',
              },
              {
                num: '02',
                icon: SunMedium,
                title: 'Cosecha',
                desc: 'Selección manual de cerezas en su punto exacto de maduración',
              },
              {
                num: '03',
                icon: FlaskConical,
                title: 'Proceso',
                desc: 'Lavado, Natural o Honey según el perfil sensorial deseado para ese lote',
              },
              {
                num: '04',
                icon: Flame,
                title: 'Tueste',
                desc: 'Perfil de tueste único por origen, ejecutado en lotes pequeños a pedido',
              },
              {
                num: '05',
                icon: Coffee,
                title: 'Tu Taza',
                desc: 'Envío dentro de los 7 días del tueste para máxima frescura garantizada',
              },
              ...
              <ScrollReveal
                ...
                delay={i * 0.12}
                direction="up"
                className="flex-1 w-full flex flex-col items-center text-center px-4 py-4 md:py-6 relative z-10"
              >
                ...
                <h3 className="font-serif text-lg md:text-xl text-coffee-900 dark:text-cream mb-1 md:mb-2">
                  {title}
                </h3>
                <p className="text-coffee-600 dark:text-coffee-400 text-xs leading-relaxed max-w-[240px] md:max-w-[180px]">
                  {desc}
                </p>
              </ScrollReveal>
            ))}
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-coffee-50 dark:bg-coffee-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal className="text-center mb-16">
            ...
            <p className="text-coffee-700 dark:text-coffee-300 mt-4 max-w-xl mx-auto">
              Más de 400 suscriptores en México. Esto es lo que nos comparten.
            </p>
          </ScrollReveal>
            ...
            {[
              {
                ...
                stars: 5,
                quote:
                  'La tostión del Chiapas Geisha fue reveladora. Nunca había probado notas tan claras de jazmín y durazno en una taza. Completamente diferente a lo que conocía.',
              },
              {
                name: 'Ana P.',
                ...
                stars: 5,
                quote:
                  'Soy suscriptora desde el primer lote. La trazabilidad real, con nombre del productor y altitud de la finca, me hace sentir conexión genuina con el origen.',
              },
              {
                name: 'Rodrigo V.',
                location: 'Monterrey',
                stars: 5,
                quote:
                  'El pedido llega en 48h perfectamente empacado con las notas de catación impresas. Se nota el cuidado en cada detalle. Vale cada peso.',
              },
              ...
              <ScrollReveal key={name} delay={i * 0.12}>
                <div className="bg-white dark:bg-coffee-900 border border-coffee-200 dark:border-coffee-800 hover:border-gold-500/30 transition-all duration-300 p-8 flex flex-col gap-6 h-full">
                  ...
                  <p className="text-coffee-800 dark:text-coffee-300 text-sm leading-relaxed italic flex-1">
                    "{quote}"
                  </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-12">
            ...
            <ScrollReveal delay={0.1}>
              <Link
                to="/tienda"
                className="hidden sm:flex items-center gap-2 text-gold-400 hover:text-gold-300 transition-colors text-sm tracking-widest uppercase"
              >
          ...
          {featuredLoading ? (
            ...
            <p className="text-center text-coffee-500 dark:text-coffee-400 py-8">
          ...
          <div className="text-center mt-10 sm:hidden">
            <Link to="/tienda" className="btn-outline-dark">
              Ver toda la tienda
            </Link>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              <div key={label}>
                ...
                <p className="text-coffee-700 dark:text-gold-400/90 text-sm mt-2 uppercase tracking-widest">
                  {label}
                </p>
              </div>
            ))}
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-coffee-100 dark:bg-coffee-900 border-t border-coffee-200/40 dark:border-coffee-800/40">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-coffee-600 dark:text-coffee-400 text-base max-w-xl mx-auto mb-12">
            Guías paso a paso, modo en vivo y un sistema de niveles para convertirte en barista de
            especialidad.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10">
            {[
              {
                icon: <BookOpen className="w-7 h-7 text-gold-500" />,
                title: 'Recetas guiadas',
                desc: 'V60, AeroPress, Espresso y más. Cada método explicado en detalle.',
              },
              {
                icon: <Play className="w-7 h-7 text-gold-500" />,
                title: 'Modo en vivo',
                desc: 'Sigue los pasos en pantalla completa con temporizadores integrados.',
              },
              {
                icon: <Trophy className="w-7 h-7 text-gold-500" />,
                title: 'Niveles de Barista',
                desc: 'Gana XP con cada brew, desbloquea logros y sube en el ranking.',
              },
            ].map(({ icon, title, desc }) => (
              <div
                key={title}
                className="bg-coffee-50 dark:bg-coffee-950/60 border border-coffee-200 dark:border-coffee-800 p-6 text-left hover:border-gold-500/40 transition-colors"
              >
      ...
      <section className="py-16 sm:py-20 lg:py-24 px-4 bg-coffee-50 dark:bg-coffee-950 border-t border-coffee-200/40 dark:border-coffee-800/40">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <h2 className="font-serif text-3xl sm:text-4xl text-coffee-900 dark:text-cream">
              Calendario de Tueste
            </h2>
            <p className="text-coffee-600 dark:text-coffee-400 mt-3 max-w-md mx-auto">
              Tostamos por lotes pequeños, bajo pedido. Tu café llega máximo 7 días después del
              tueste.
            </p>
          </div>
            ...
            {(['Lunes', 'Miércoles', 'Viernes', 'Sábado'] as const).map((day, i) => {
              ...
              return (
                ...
                >
                  ...
                  <p
                    className={`font-medium ${isToday ? 'text-coffee-900 dark:text-cream' : 'text-coffee-700 dark:text-coffee-300'}`}
                  >
                    {day}
                  </p>
