    ...
    <div className="space-y-4">
      ...
      {orders.map((order: Order, i: number) => (
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3 mt-4 pt-3 border-t border-coffee-100 dark:border-coffee-800">
            <Link
              to={`/perfil/pedidos/${order.id}`}
              className="inline-flex items-center justify-center min-h-[44px] sm:min-h-0 text-sm sm:text-xs text-gold-500 hover:text-gold-400 border border-gold-500/30 px-4 sm:px-3 py-2.5 sm:py-1.5 transition-colors active:scale-95 touch-manipulation"
            >
              Ver detalle
            </Link>
            <button
              ...
              className="inline-flex items-center justify-center min-h-[44px] sm:min-h-0 gap-1.5 text-sm sm:text-xs text-coffee-700 dark:text-coffee-300 hover:text-coffee-900 dark:hover:text-cream border border-coffee-300 dark:border-coffee-700 px-4 sm:px-3 py-2.5 sm:py-1.5 transition-colors active:scale-95 touch-manipulation"
            >
              <ShoppingBag className="w-4 h-4 sm:w-3 sm:h-3" />
              Volver a pedir
            </button>
          </div>
        </motion.div>
