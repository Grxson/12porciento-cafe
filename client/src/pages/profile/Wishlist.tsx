...
import { Heart, ShoppingBag, Trash2, AlertTriangle, CheckCircle, PackageX } from 'lucide-react';
...
export default function Wishlist() {
  ...
  const fetchItems = () => {
    ...
    setError('');
    wishlistApi.list()
      .then((r) => setItems(r.data.data.map((i) => ({ ...i.product, wishlistId: i.id }))))
      .catch(() => setError('Error al cargar lista de deseos.'))
