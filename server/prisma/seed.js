...
const products = [
  {
    ...
    recipes: JSON.stringify([
      { title: 'V60', method: 'Filtro', temp: '92°C', grind: 'Medio-fino', ratio: '1:15', steps: ['Moler 15g de café', 'Pre-infusión 30s con 50ml', 'Verter 200ml en 2-3 pulsos', 'Extracción en 3:00-3:30 min'] },
      { title: 'Prensa Francesa', method: 'Inmersión', temp: '94°C', grind: 'Grueso', ratio: '1:12', steps: ['Moler 20g de café', 'Agregar 240ml de agua', 'Revolver y esperar 4 min', 'Presionar lentamente y servir'] }
    ]),
  ...
  },
  {
    ...
    recipes: JSON.stringify([
      { title: 'Chemex', method: 'Filtro', temp: '93°C', grind: 'Medio', ratio: '1:15', steps: ['Moler 30g', 'Pre-infusión 45s', 'Verter 450ml en círculos', 'Extraer en 4:00 min'] },
      { title: 'Moka', method: 'Presión', temp: 'Fuego medio', grind: 'Fino', ratio: '1:7', steps: ['Llenar canasta con café', 'Agua fría hasta válvula', 'Fuego medio-bajo', 'Retirar al silbido'] }
    ]),
  ...
  },
  {
    ...
    recipes: JSON.stringify([
      { title: 'Pour Over V60', method: 'Filtro', temp: '91°C', grind: 'Medio-fino', ratio: '1:16', steps: ['Moler 12g', 'Pre-infusión suave 25s', 'Verter en espiral hacia afuera', 'Total 3:00-3:30 min'] }
    ]),
  ...
  },
  {
    ...
    recipes: JSON.stringify([
      { title: 'Kalita Wave', method: 'Filtro', temp: '90°C', grind: 'Medio', ratio: '1:17', steps: ['Moler 10g café', 'Pre-infusión 30s con 20ml', 'Verter en pulsos de 50ml', 'Extracción 3:30-4:00 min'] }
    ]),
  ...
  },
  {
    ...
    recipes: JSON.stringify([
      { title: 'Cold Brew', method: 'Inmersión fría', temp: '4°C (refrigerador)', grind: 'Extra grueso', ratio: '1:8', steps: ['Moler 60g', 'Mezclar con 500ml agua fría', 'Refrigerar 16-24 horas', 'Filtrar y servir con hielo'] }
    ]),
  ...
  },
  {
    ...
    recipes: JSON.stringify([
      { title: 'Espresso', method: 'Presión', temp: '93°C', grind: 'Muy fino', ratio: '1:2', steps: ['Moler 18g', 'Tampar con 30kg de presión', 'Extraer en 25-30s', 'Rendimiento: 36ml'] },
      { title: 'Americano', method: 'Espresso + agua', temp: '93°C', grind: 'Muy fino', ratio: '1:5', steps: ['Preparar espresso 18g/36ml', 'Agregar 150ml agua caliente', 'Servir inmediatamente'] }
    ]),
