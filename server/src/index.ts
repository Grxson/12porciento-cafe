...
import shippingRatesRouter from './routes/shippingRates';
...
import recipeFavoritesRouter from './routes/recipe-favorites';
...
import adminBaristaRouter from './routes/admin/barista';
...
import tiposCataRouter from './routes/tipos-cata';
...
app.use('/api/shipping-rates', adminLimiter, shippingRatesRouter);
...
app.use('/api/recipe-favorites', recipeFavoritesRouter);
...
app.use('/api/admin/rewards', adminBaristaRouter);
app.use('/api/lotes', adminLimiter, lotesRouter);
app.use('/api/caficultores', adminLimiter, caficultoresRouter);
app.use('/api/ubicaciones', adminLimiter, ubicacionesRouter);
...
// SPA serving removed — web and admin are separate Railway services
